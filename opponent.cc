...
void OpponentProjectile::Draw(graphics::Image& screen) {
  ...
  screen.DrawLine((GetX() + 2), (GetY() + 1), (GetX() + 2), (GetY() + 3), eAmmo);
}

void Opponent::Draw(graphics::Image& screen) {
  graphics::Color black(0, 0, 0);
  graphics::Color grey(75, 75, 70);
  screen.DrawLine((GetX() + 19), (GetY() + 12), (GetX() + 28), (GetY() + 12), grey);
  screen.DrawLine((GetX() + 17), (GetY() + 13), (GetX() + 30), (GetY() + 13), grey);
  screen.DrawRectangle((GetX() + 16), (GetY() + 14), 16, 2, grey);
  screen.DrawLine((GetX() + 15), (GetY() + 16), (GetX() + 32), (GetY() + 16), grey);
  ...
  screen.DrawLine((GetX() + 20), (GetY() + 25), (GetX() + 27), (GetY() + 25), grey);
  screen.DrawRectangle((GetX() + 16), (GetY() + 26), 16, 2, grey);
  screen.DrawLine((GetX() + 17), (GetY() + 28), (GetX() + 20), (GetY() + 28), grey);
  screen.DrawLine((GetX() + 21), (GetY() + 28), (GetX() + 26), (GetY() + 28), black);
  screen.DrawLine((GetX() + 27), (GetY() + 28), (GetX() + 30), (GetY() + 28), grey);
  screen.DrawLine((GetX() + 19), (GetY() + 29), (GetX() + 21), (GetY() + 29), grey);
  screen.DrawLine((GetX() + 22), (GetY() + 29), (GetX() + 25), (GetY() + 29), black);
  screen.DrawLine((GetX() + 26), (GetY() + 29), (GetX() + 28), (GetY() + 29), grey);
  screen.DrawRectangle((GetX() + 19), (GetY() + 30), 10, 2, grey);
  screen.DrawLine((GetX() + 20), (GetY() + 32), (GetX() + 27), (GetY() + 32), grey);
}
...
std::unique_ptr<OpponentProjectile> Opponent::LaunchProjectile() {
  launch_counter += 1;
  if (launch_counter % 5 == 0) {
    std::unique_ptr<OpponentProjectile> new_launch = std::make_unique<OpponentProjectile>(GetX(), GetY());
